...
if(isset($_POST["submit"]))
{
    if($_POST["username"])
    {
        ...
        $sql = "DELETE FROM Worker WHERE User='$username' AND Password='$password'";
        $result = mysqli_query($conn,$sql);
        $sq="DROP TABLE $username";
        ...
        <form method="post" action="#">
            <div class="menu-icon">
                <img src="user.svg" id="userimg"/><br>
                 <p style="text-align: center">Remove Worker</p>
                ...
                <input type="submit" value="Remove Worker" name="submit" style="margin-left: 150px">
