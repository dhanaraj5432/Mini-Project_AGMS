...
if(isset($_POST["submit"]))
{
    if($_POST["username"])
    {
        ...
        $sql = "DELETE FROM User WHERE User='$username' AND Password='$password'";
        $result = mysqli_query($conn,$sql);
        $sq="DELETE FROM plumber WHERE User='$username' AND Password='$password'";
        ...
        <form method="post" action="#">
            <div class="menu-icon">
                <img src="user.svg" id="userimg"/><br>
                 <p style="text-align: center">Remove User</p>
                ...
                <input type="submit" value="Remove User" name="submit" style="margin-left: 150px">
