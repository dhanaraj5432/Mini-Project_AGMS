...
$sq="INSERT INTO electrician (Username,Roomnum,Problem,Workertype) VALUES ('$username',$roomnum,'$problem','$Worker')";
...
<body>
	<a href="solved.php"><div class="menu-icon1" name="electrician">Solved Problems</div></a>
	<a href="solve.php"><div class="menu-icon2" name="electrician">To be Solve</div></a>
</body>
</html>